    ...
    <div>
      {information.map(
        (item: any, index: number): ReactElement => (
          <div key={index}>
            {item.completed || !item || !item.task ? (
              ""
            ) : (
              <div className="rounded-md  m-2 flex justify-between tasks text-[1.2em]  bg-[#1e1e1e] text-[#e1d3d3] z-[-9] cursor-pointer ">
